...
//     def branch = params.BRANCH ?: env.BRANCH ?: BRANCH_NAME
...
def call() {
    ...
    def branch = params.BRANCH ?: env.BRANCH ?: env.GIT_BRANCH ?: sh(script: "git rev-parse --abbrev-ref HEAD", returnStdout: true).trim()
